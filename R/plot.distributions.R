...
#'  \code{\link{auto.corr.test.DT}}, \code{\link{runs.test.BM}}).
#'
#' @param y a paleoTS object
#'
#'sim.data, obs, test, xlab, main)
...
#'
#' @param main main label on plot
#'
#' @details xlab and main is not necessary to define for the function to work.
#'
...
#'
#'## run the test
#'for.plotting<-auto.corr.test.DT(x,mstep,vstep)
#'
#'## plot
...
plot.distributions<-function(sim.data, obs, test, xlab, main){
  ...
  hist(sim.data, xlim=c(low,high), main=main, xlab=xlab)
