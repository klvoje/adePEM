#' @title Applying 3 adequasy tests to the Directional trend model
#'
...
#'fit3adequasy.trend(x,mstep,vstep)
#'

fit3adequasy.trend<-function(y, mstep, vstep, nrep=1000, conf=0.95, plot=TRUE){
