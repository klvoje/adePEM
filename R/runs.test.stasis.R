#' @title Applying the runs test to the stasis model
#'
...
#'
#' @details This function applies a runs test in order to investigate if the stasis model can be judged an
...
runs.test.stasis<-function(y, theta, omega, nrep=1000, conf=0.95, plot=TRUE, save.replicates=TRUE){
